        ...
        <footer id="footer">
            <div className="footer-container">
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#mnotes">Notes</a></li>
                        <li><a href="#mpyqs-year">PYQs</a></li>
                        <li><a href="#mexercises">Exercises</a></li>
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="#mexercises">Practice Questions</a></li>
                        <li><a href="#mpyqs-year">Mock Tests</a></li>
                        <li><a href="mncert-solution">Doubt Solving</a></li>
                        <li><a href="#mncert-books">CBSE Resources</a></li>
                    </ul>
                </div>
                <div className="footer-col">
